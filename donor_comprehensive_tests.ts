...
export const DONOR_TEST_CATEGORIES = [
...
export const INITIAL_DONOR_TESTS: MedicalTestItem[] = [
    // --- Blood Tests & Laboratory Studies ---
    ...
    // Diabetic Profile
    { id: 'fbs', name: 'Fasting Blood Sugar (FBS)', value: '', unit: 'mg/dL', normalRange: '70-100', isAbnormal: false, isCompleted: false, category: 'Blood Tests & Laboratory Studies', inputType: 'number' },
    { id: 'ppbs', name: 'Post Prandial (PP)', value: '', unit: 'mg/dL', normalRange: '70-140', isAbnormal: false, isCompleted: false, category: 'Blood Tests & Laboratory Studies', inputType: 'number' },
    ...
    // Other Blood Tests
    { id: 'calcium', name: 'Calcium (Ca)', value: '', unit: 'mg/dL', normalRange: '8.6-10.3', isAbnormal: false, isCompleted: false, category: 'Blood Tests & Laboratory Studies', inputType: 'number' },
    ...
    // --- Urine & Stool Tests ---
    { id: 'urine_re', name: 'Urine R/E', value: '', isAbnormal: false, isCompleted: false, category: 'Urine & Stool Tests', inputType: 'text', normalRange: 'Clear, pH 5-8' },
    { id: 'urine_cs', name: 'Urine C/S', value: '', isAbnormal: false, isCompleted: false, category: 'Urine & Stool Tests', inputType: 'dropdown', dropdownOptions: ['No Growth', 'Positive'], conditionalInput: { onValue: 'Positive', placeholder: 'Specify organism' } },
    { id: 'pregnancy_test', name: 'Urine Pregnancy Test', value: '', isAbnormal: false, isCompleted: false, category: 'Urine & Stool Tests', conditional: { type: 'gender', condition: 'Female' }, inputType: 'dropdown', dropdownOptions: ['Negative', 'Positive'] },
    { id: 'urine_24h_protein', name: '24hr Urinary Total Protein', value: '', unit: 'mg/day', normalRange: '<150', isAbnormal: false, isCompleted: false, category: 'Urine & Stool Tests', inputType: 'number' },
    { id: 'stool_re', name: 'Stool R/E', value: '', isAbnormal: false, isCompleted: false, category: 'Urine & Stool Tests', inputType: 'text', normalRange: 'No parasites/ova' },
    { id: 'stool_occult', name: 'Stool Occult Blood', value: '', isAbnormal: false, isCompleted: false, category: 'Urine & Stool Tests', inputType: 'dropdown', dropdownOptions: ['Negative', 'Positive'] },

    // --- Imaging Tests ---
    { id: 'chest_xray', name: 'Chest X-ray P/A view', value: '', isAbnormal: false, isCompleted: false, category: 'Imaging Tests', inputType: 'text', normalRange: 'Clear lung fields' },
    { id: 'kub_xray', name: 'X-ray KUB', value: '', isAbnormal: false, isCompleted: false, category: 'Imaging Tests', inputType: 'text', normalRange: 'No calcification' },
    { id: 'ecg', name: 'ECG', value: '', isAbnormal: false, isCompleted: false, category: 'Imaging Tests', inputType: 'text', normalRange: 'Normal sinus rhythm' },
    { id: 'echo', name: 'ECHO', value: '', isAbnormal: false, isCompleted: false, category: 'Imaging Tests', inputType: 'text', normalRange: 'Normal EF' },
    { id: 'usg_abdomen', name: 'USG Abdomen & Pelvis', value: '', isAbnormal: false, isCompleted: false, category: 'Imaging Tests', inputType: 'text', normalRange: 'Normal organ size' },

    // --- Specialized Tests ---
    { id: 'sputum_afb', name: 'Sputum AFB: I & II', value: '', isAbnormal: false, isCompleted: false, category: 'Specialized Tests', inputType: 'dropdown', dropdownOptions: ['Negative', 'Positive'] },
    { id: 'sputum_cs', name: 'Sputum C/S', value: '', isAbnormal: false, isCompleted: false, category: 'Specialized Tests', inputType: 'dropdown', dropdownOptions: ['No Growth', 'Positive'], conditionalInput: { onValue: 'Positive', placeholder: 'Specify organism' } },
    { id: 'colonoscopy', name: 'Colonoscopy', value: '', isAbnormal: false, isCompleted: false, category: 'Specialized Tests', conditional: { type: 'age', condition: { min: 60 } }, inputType: 'text', normalRange: 'Normal findings' },
];
